...
|---|---|---|---|
| [M1](M1-startup.md) | Startup Time & Ready Signal | `rust/src/api/api.rs`, `rust/src/lib.rs` | Proposed |
...
| [M3](M3-ui-responsiveness.md) | UI Responsiveness | `MessageWidgetController`, `GlobalChatService`, `contact_service.dart` | Proposed |
| [M4](M4-memory.md) | Memory Footprint | `ConversationViewController`, `eraseCloudKitSync`, `MethodCallHandler.kt` | Proposed |
