...
| [ADR-002](.agents/adrs/ADR-002-tokio-worker-threads.md) | Increase Tokio worker thread count | ✅ Implemented (M1.2) |
| [ADR-003](.agents/adrs/ADR-003-async-file-io.md) | Replace blocking file I/O with tokio::fs | ✅ Implemented (M1.3) |
...
| [ADR-009](.agents/adrs/ADR-009-dpoll-backoff.md) | Exponential backoff in doPoll() | ✅ Implemented (M2.1) |
...
| [ADR-016](.agents/adrs/ADR-016-parallel-sync.md) | Concurrent chat and handle sync | ✅ Implemented (M6.2) |
